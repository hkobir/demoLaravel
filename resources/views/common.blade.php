...
<html lang="en">
    ...
    <body>
        ...
        <nav class="navbar navbar-expand-lg navbar-light fixed-top" id="mainNav">
            <div class="container">
                <a class="navbar-brand" href="{{url('/')}}">HK BlogSpot</a>
                ...
                <div class="row">
                    <div class="col-lg-8 col-md-10 mx-auto">
                        <div class="site-heading">
                            <h1>Open Blog</h1>
                            <span class="subheading">A Platform where by you might able to share knowledge</span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-8 col-md-10 mx-auto">
                        ...
                        <p class="copyright text-muted">Copyright &copy; HK BlogSpot 2020</p>
                    </div>
                </div>
            </div>
        </footer>
        ...
        $(document).on("click", "#delete", function(e){
            ...
            var link = $(this).attr("href");   //link of clicked element
